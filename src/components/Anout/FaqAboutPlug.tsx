    ...
    <Box className="my-10">
      ...
      <Accordion sx={{ background: "#e6e9e9" }}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <span className="font-bold mb-5 text-center">Who is rizz tech?</span>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            rizz is a leading U.S. electronics provider that connects people
      ...
      <Accordion sx={{ background: "#e6e9e9" }}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            helping to ensure the only difference between a new and rizz 
            ...
            graded, and shipped from rizz ’s headquarters in St. Louis, Missouri,
      ...
      <Accordion sx={{ background: "#e6e9e9" }}>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <span className="font-bold mb-5 text-center">
            What is the rizz mission statement?
          </span>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion sx={{ background: "#e6e9e9" }}>
        ...
        <AccordionDetails>
          <Typography>
            ...
            e-waste around the globe. To date, rizz has helped to save over one
